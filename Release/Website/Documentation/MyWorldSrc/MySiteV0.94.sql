...
--
-- Table structure for table `serverhosts`
--

DROP TABLE IF EXISTS `serverhosts`;
CREATE TABLE `serverhosts` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ServerName` varchar(32) NOT NULL,
  `AccountName` varchar(32) NOT NULL,
  `AcctPassword` varchar(32) NOT NULL,
  `externalIP` varchar(64) NOT NULL,
  `internalIP` varchar(64) NOT NULL,
  `PortList` varchar(120) NOT NULL DEFAULT '',
  PRIMARY KEY (`ID`),
  KEY `IDX_ServerName` (`ServerName`),
  KEY `IDX_externalIP` (`externalIP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `serverports`;
