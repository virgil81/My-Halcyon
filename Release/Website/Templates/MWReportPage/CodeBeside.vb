...
Partial Class $codebesideclassname$
 ...
 Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  If Trace.IsEnabled Then Trace.Warn("TempRpt", "Start Page Load")
  ...
  If Not IsPostBack Then                                   ' First time page is called setup
   ...
   SBMenu.AddItem("P", "TempSelect.aspx", "Report Selection")
   If Trace.IsEnabled Then Trace.Warn("TempRpt", "Show Menu")
  ...
  SQLCmd = "Select KeyID,Name " +
           "From Table " +
           "Order by SortOrder"
  If Trace.IsEnabled Then Trace.Warn("TempRpt", "Get SQLCmd: " + SQLCmd.ToString())
