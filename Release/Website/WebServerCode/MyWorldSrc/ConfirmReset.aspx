<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConfirmReset.aspx.vb" Inherits="ConfirmReset" %>
    ...
    <tr>
     <td class="BodyBg">
      <table style="width: 100%;">
       ...
       <tr id="EmailFail" runat="server">
        <td>
         Since Email process is not working:
         <b>New Password:</b> <span id="NewPass" runat="server" style="font-size:18px;"></span><br />
         Please logon and change your password!
        </td>
       </tr>
      </table>
     </td>
