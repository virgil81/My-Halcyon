<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ServerSelect.aspx.vb" Inherits="Administration_ServerSelect" %>
       ...
       <tr>
        <td>
         <asp:GridView ID="gvDisplay" runat="server" AllowPaging="False" AutoGenerateColumns="False" GridLines="None" CellSpacing="1" Width="100%" HeaderStyle-Height="28px" PagerStyle-HorizontalAlign="Center" AlternatingRowStyle-CssClass="AltLine">
          <Columns>
           <asp:TemplateField HeaderText="Server Name" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="Title" ItemStyle-Width="60%">
            <ItemTemplate>
             <span onclick="CallEdit(<%#Container.DataItem("ID")%>,'ServerForm.aspx');" class="NavLink" onmouseover="this.className='NOverLink';" onmouseout="this.className='NavLink';">
              <%#Container.DataItem("ServerName").ToString().Trim()%>
             </span>
            </ItemTemplate>
           </asp:TemplateField>
           <asp:TemplateField HeaderText="Ext IP" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="Title" ItemStyle-Width="20%">
            <ItemTemplate>
             <%#Container.DataItem("externalIP").ToString()%>
            </ItemTemplate>
           </asp:TemplateField>
           <asp:TemplateField HeaderText="Int IP" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="Title" ItemStyle-Width="20%">
            <ItemTemplate>
             <%#Container.DataItem("internalIP").ToString()%>
            </ItemTemplate>
           </asp:TemplateField>
          </Columns>
