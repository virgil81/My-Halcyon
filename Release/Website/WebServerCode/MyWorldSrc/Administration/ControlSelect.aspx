<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ControlSelect.aspx.vb" Inherits="Administration_ControlSelect" %>
       ...
       <tr>
        <td>
         <asp:GridView ID="gvDisplay" runat="server" AllowPaging="False" AutoGenerateColumns="False" GridLines="None" CellSpacing="1" style=" width:100%;" HeaderStyle-Height="28px" PagerStyle-HorizontalAlign="Center" AlternatingRowStyle-CssClass="AltLine">
          <Columns>
           <asp:TemplateField HeaderText="Control Entries" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="Title">
            <ItemTemplate>
             <span onclick="CallEdit('<%#Container.DataItem("Name")%>','ControlForm.aspx');" class="NavLink" onmouseover="this.className='NOverLink';" onmouseout="this.className='NavLink';">
