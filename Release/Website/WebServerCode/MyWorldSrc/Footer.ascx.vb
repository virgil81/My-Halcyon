...
Partial Class Footer
 ...
 '*************************************************************************************************
 '* Common user control for all website pages to display the site copyright for its contents. 
 '* The web pages and programming for operation only is open source content, not your information!
 '* 
