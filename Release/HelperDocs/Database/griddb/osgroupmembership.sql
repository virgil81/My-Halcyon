...
--
-- Dumping data for table `osgroupmembership`
--

LOCK TABLES `osgroupmembership` WRITE;
/*!40000 ALTER TABLE `osgroupmembership` DISABLE KEYS */;
/*!40000 ALTER TABLE `osgroupmembership` ENABLE KEYS */;
UNLOCK TABLES;
