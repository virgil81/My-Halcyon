...
--
-- Dumping data for table `osgrouprolemembership`
--

LOCK TABLES `osgrouprolemembership` WRITE;
/*!40000 ALTER TABLE `osgrouprolemembership` DISABLE KEYS */;
/*!40000 ALTER TABLE `osgrouprolemembership` ENABLE KEYS */;
UNLOCK TABLES;
