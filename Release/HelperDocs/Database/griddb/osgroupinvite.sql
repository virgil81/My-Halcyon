...
--
-- Dumping data for table `osgroupinvite`
--

LOCK TABLES `osgroupinvite` WRITE;
/*!40000 ALTER TABLE `osgroupinvite` DISABLE KEYS */;
/*!40000 ALTER TABLE `osgroupinvite` ENABLE KEYS */;
UNLOCK TABLES;
