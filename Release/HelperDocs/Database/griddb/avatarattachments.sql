...
--
-- Dumping data for table `avatarattachments`
--

LOCK TABLES `avatarattachments` WRITE;
/*!40000 ALTER TABLE `avatarattachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `avatarattachments` ENABLE KEYS */;
UNLOCK TABLES;
