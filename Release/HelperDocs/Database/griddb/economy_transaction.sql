...
--
-- Dumping data for table `economy_transaction`
--

LOCK TABLES `economy_transaction` WRITE;
/*!40000 ALTER TABLE `economy_transaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `economy_transaction` ENABLE KEYS */;
UNLOCK TABLES;
