...
--
-- Dumping data for table `osgroupnotice`
--

LOCK TABLES `osgroupnotice` WRITE;
/*!40000 ALTER TABLE `osgroupnotice` DISABLE KEYS */;
/*!40000 ALTER TABLE `osgroupnotice` ENABLE KEYS */;
UNLOCK TABLES;
