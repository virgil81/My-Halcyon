...
--
-- Dumping data for table `hostsregister`
--

LOCK TABLES `hostsregister` WRITE;
/*!40000 ALTER TABLE `hostsregister` DISABLE KEYS */;
/*!40000 ALTER TABLE `hostsregister` ENABLE KEYS */;
UNLOCK TABLES;
