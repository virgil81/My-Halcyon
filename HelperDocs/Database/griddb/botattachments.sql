...
--
-- Dumping data for table `botattachments`
--

LOCK TABLES `botattachments` WRITE;
/*!40000 ALTER TABLE `botattachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `botattachments` ENABLE KEYS */;
UNLOCK TABLES;
