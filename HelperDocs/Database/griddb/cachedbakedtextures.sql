...
--
-- Dumping data for table `cachedbakedtextures`
--

LOCK TABLES `cachedbakedtextures` WRITE;
/*!40000 ALTER TABLE `cachedbakedtextures` DISABLE KEYS */;
/*!40000 ALTER TABLE `cachedbakedtextures` ENABLE KEYS */;
UNLOCK TABLES;
