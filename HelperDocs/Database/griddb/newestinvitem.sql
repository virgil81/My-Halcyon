...
--
-- Dumping data for table `newestinvitem`
--

LOCK TABLES `newestinvitem` WRITE;
/*!40000 ALTER TABLE `newestinvitem` DISABLE KEYS */;
/*!40000 ALTER TABLE `newestinvitem` ENABLE KEYS */;
UNLOCK TABLES;
