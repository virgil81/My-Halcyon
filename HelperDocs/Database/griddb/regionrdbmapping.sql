...
--
-- Dumping data for table `regionrdbmapping`
--

LOCK TABLES `regionrdbmapping` WRITE;
/*!40000 ALTER TABLE `regionrdbmapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `regionrdbmapping` ENABLE KEYS */;
UNLOCK TABLES;
